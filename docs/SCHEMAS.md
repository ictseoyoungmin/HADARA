...
| `hadara.packageRecycle.v1` | `src/schemas/package-recycle.schema.json` | fixture | Documents dry-run-first installed-package recycle reports over npm registry metadata, isolated-prefix package install, installed CLI lifecycle/init/task/context/session smokes, cleanup, and no publish/release mutation markers. |
