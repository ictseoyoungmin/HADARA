...
| `hadara.task.close.v1` | `src/schemas/task-close.schema.json` | fixture | Documents task close plan and execute reports with close-evidence loop-boundary metadata. |
