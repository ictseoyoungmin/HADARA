...
| `hadara.task.close.v2` | `src/schemas/task-close-v2.schema.json` | fixture | Documents the public 0.5 task close transaction report, including close state, transaction mode, plan hash, write summary, recovery guidance, and embedded finalize-source metadata. |
