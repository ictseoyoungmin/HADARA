...
| `hadara.task.selection.v1` | `src/schemas/task-selection.schema.json` | fixture | Documents the internal task-selection projection consumed by `task status --json` from handoff, slices, Task Board fallback, and backlog state. |
