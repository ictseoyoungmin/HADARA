...
- T-0109 TUI Local Cache and Incremental Refresh: done; adds internal `.hadara/local/tui/` cache records, task index hash/mtime invalidation, full/fast/detail/none refresh modes, opt-in `hadara tui --cache`, context-export exclusion tests, and 1000-capsule benchmark evidence.
