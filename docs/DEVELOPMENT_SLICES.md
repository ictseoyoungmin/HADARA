...
| 2 | Harness replay skeleton | TBD | Add deterministic replay schema and ScriptedProvider-backed no-op scenario checks. | Harness replay test and JSON output evidence. |
