...
| 3 | CLI JSON normalization | T-0011 | Apply common JSON envelope and exit codes to core CLI commands. | Done: `doctor --json` envelope, text output, and exit code 7 smoke recorded. |
