...
| 3 | CLI JSON normalization | T-0011, T-0012, T-0013 | Apply common JSON envelope and exit codes to core CLI commands. | Done so far: doctor, task list/show, policy check-shell JSON plus failure exit smokes. |
