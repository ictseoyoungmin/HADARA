...
| Area | State | Notes |
|---|---|---|
| Branch | main | Working tree contains completed T-0160 protocol doctor all-scope changes. |
...
| Active / Next Task | TBD | Operator should choose the next capsule; no T-0161 capsule has been pre-created. |
...
|---|---|---|
| Choose the next capsule. | T-0160 completes the all-scope protocol doctor follow-up requested after T-0159. | No T-0161 capsule is pre-created; use `docs/TASK_BOARD.md` and `docs/DEVELOPMENT_SLICES.md` to select the next work item. |
