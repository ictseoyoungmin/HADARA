...
| `task complete --task T-XXXX --json` | `hadara.commandRemoved.v1` | Removed redirect stub. | Redirect report was generated. |
| `task lifecycle --task T-XXXX --json` | `hadara.commandRemoved.v1` | Removed redirect stub. | Redirect report was generated. |
...
| `handoff suggest --task T-XXXX --json` | `hadara.commandRemoved.v1` | Removed redirect stub. | Redirect report was generated. |
| `handoff stale-problems --json` | `hadara.commandRemoved.v1` | Removed redirect stub. | Redirect report was generated. |
...
| `task ready --task T-XXXX --level done --json` | `hadara.commandRemoved.v1` | Removed redirect stub. | Redirect report was generated. |
| `task finish --task T-XXXX --json` | `hadara.commandRemoved.v1` | Removed redirect stub. | Redirect report was generated. |
| `task finish --task T-XXXX --execute --json` | `hadara.commandRemoved.v1` | Removed redirect stub; no standalone write path. | Redirect report was generated. |
| `task close --task T-XXXX --json` | `hadara.commandRemoved.v1` | Removed redirect stub. | Redirect report was generated. |
| `task close --task T-XXXX --execute --json` | `hadara.commandRemoved.v1` | Removed redirect stub; close evidence is appended through guarded finalize only. | Redirect report was generated. |
| `task audit-close --task T-XXXX --json` | `hadara.commandRemoved.v1` | Removed redirect stub. | Redirect report was generated. |
