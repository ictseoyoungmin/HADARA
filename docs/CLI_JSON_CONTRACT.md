...
| `task finalize --task T-XXXX --json` | `hadara.task.finalize.v1` | Read-only reviewed lifecycle plan; execute unsupported in T-0396. | All finalize steps are satisfied. |
