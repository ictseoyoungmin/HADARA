...
| `ci gate --mode advisory|strict [--task T-XXXX] --json` | `hadara.ci.gate.v1` | Read-only. | CI gate report was generated; strict mode returns `ok:false` on blockers, advisory mode keeps blockers advisory. |
