...
| After validation | `validation run`, `evidence summary`, `evidence project` when available | Update `TASK.md` Validation and Acceptance deliberately with evidence ids or residual notes. | Execute real checks through HADARA when possible and record what remains. |
