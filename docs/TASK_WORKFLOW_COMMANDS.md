...
- `task finalize` is a read-only reviewed lifecycle plan. It reports ordered finish/ready/close/audit steps, write boundaries, expected write paths, and a `planHash`; T-0396 refuses execute mode instead of orchestrating writes.
