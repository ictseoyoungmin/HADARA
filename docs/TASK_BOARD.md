...
| T-0245 | Release Artifact Evidence Refresh | In Progress | tasks/T-0245-release-artifact-evidence-refresh | Scaffold/scope prepared; commit before release artifact refresh to satisfy clean-worktree guard. |
