...
| T-0340 | Stable 0.3.2 Approval-Gated Publish | Blocked | tasks/T-0340-stable-0-3-2-approval-gated-publish | Stable `0.3.2` source/readiness prepared; Docker check, package smoke, clean-checkout smoke, and strict gate passed; release artifact/dry-run/publish remain blocked until the worktree is clean and explicit operator approval/authentication is provided. |
