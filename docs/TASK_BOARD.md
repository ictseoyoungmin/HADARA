...
| T-0296 | Phase 7.6 0.3.0 Release Hardening and Installed-Package Recycle | In Progress | tasks/T-0296-phase-7-6-0-3-0-release-hardening-and-installed-package-recycle | README/version/release notes, Docker baseline, package smoke, clean-checkout smoke, and installed-package recycle passed; release artifact/dry-run remains pending clean worktree. |
