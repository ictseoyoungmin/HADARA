...
| T-0111 | TUI Frame Color and Viewer Parity Fix | Done | tasks/T-0111-tui-frame-color-and-viewer-parity-fix | Switches TUI themes to mockup true-color RGB, fixes composed badge/keycap colors, colorizes detail viewer content, wires keyboard document scrolling, and matches compact mockup tab labels. |
