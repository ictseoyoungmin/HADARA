...
| T-0418 | 0.3.4 RC Approval-Gated Publish | In Progress | tasks/T-0418-0-3-4-rc-approval-gated-publish | Pre-publish registry checks passed, but publish retry must use a `/root/hadara-publish` clone refreshed to include T-0421 before operator npm publish confirmation. |
