...
| T-0418 | 0.3.4 RC Approval-Gated Publish | In Progress | tasks/T-0418-0-3-4-rc-approval-gated-publish | Pre-publish registry checks, ext4 publish dry-run, and `/root/hadara-publish` clone/build/gate preparation passed; waiting on operator npm authentication and interactive publish confirmation. |
