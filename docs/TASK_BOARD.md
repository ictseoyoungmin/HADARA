...
| T-0118 | TUI Tasks Height and Overview Copy Parity | Done | tasks/T-0118-tui-tasks-height-and-overview-copy-parity | Aligns Tasks panel height with Detail, simplifies Overview Resume Signals, and matches mockup-style Current/Previous Work Next/Proof fallback order. |
