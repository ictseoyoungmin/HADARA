...
| T-0402 | 0.3.3-rc.0 Approval-Gated Publish | Done | tasks/T-0402-0-3-3-rc-0-approval-gated-publish | Published `hadara@0.3.3-rc.0` to npm with `next`; registry, dist-tags, tarball metadata, and temp-prefix installed-bin smoke passed; close workflow pending. |
