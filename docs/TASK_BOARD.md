...
| T-0490 | stable 0.4.0 publish preparation | Done | tasks/T-0490-stable-0-4-0-publish-preparation | Source/docs/dist now target stable `0.4.0`; package smoke and clean-checkout smoke passed; operator publish helper must regenerate release artifact evidence from the clean commit before publish. |
