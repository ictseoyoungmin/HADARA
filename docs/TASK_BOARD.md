...
| T-0340 | Stable 0.3.2 Approval-Gated Publish | Blocked | tasks/T-0340-stable-0-3-2-approval-gated-publish | Stable `0.3.2` source/readiness and post-commit dry-runs passed; actual npm publish remains blocked until explicit operator approval/authentication and token availability. |
