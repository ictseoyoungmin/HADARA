...
- Current 0.4.6-rc.1 source/preparation status: T-0604 closed residual brownfield trust gaps; T-0605 improved evidence category UX and manifest inference polish; T-0606/T-0607 recorded delegated onboarding dogfood; T-0608 fixed delegated onboarding UX findings; T-0609 hardened validation execution capture; T-0610 retired stale bootstrap next-work after first close; T-0611 through T-0613 clarified current-state latest-task and trusted validation-baseline contracts; T-0614 prepared and the operator published `0.4.6-rc.0`; T-0615 dogfooded the installed rc.0 package; T-0616 through T-0619 fixed concurrent task creation, first-user docs workflow, and HADARA-dev Docker sync-build friction.
- Current 0.4.6-rc.1 readiness: focused current-state/evidence/validation tests passed for rc.0; installed rc.0 dogfood completed; task-create serialization, docs-add workflow, and Docker fast sync-build checks passed; T-0620 retargeted package metadata, release notes, readiness docs, README release status, and the GitHub prerelease note artifact to `0.4.6-rc.1`; the operator published `hadara@0.4.6-rc.1` to npm on `next` and published GitHub Release `v0.4.6-rc.1` publicly. Installed-package recycle remains a follow-up action.
...
- Current source version is `0.4.6-rc.1`.
- Current release target is prerelease `0.4.6-rc.1`.
- Current release-candidate npm publish target is `0.4.6-rc.1` on dist-tag `next`.
