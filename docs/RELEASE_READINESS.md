...
- Current 0.4.2 release-candidate installed-package status: pending. The next release follow-up should run installed-package recycle for `hadara@next` expected `0.4.2-rc.0` from a dedicated capsule.
