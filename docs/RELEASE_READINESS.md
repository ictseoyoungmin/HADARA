...
- Current source version is `0.4.4`.
- Current release target is stable `0.4.4`.
- Current stable npm publish target is `0.4.4` on dist-tag `latest`.
- Current published stable npm release target remains `0.4.3` until the operator publishes `0.4.4`.
