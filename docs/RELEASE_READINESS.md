...
- Current release target: complete the separate T-0778 public RC5 consumer recycle, including real close execution, `closed-valid`, idempotent retry, and fresh idle status; then reconcile stable-promotion readiness.
