...
- Current release target: RC4 exact-artifact retention, npm/GitHub publication, and public package recycle are complete; stable promotion remains pending the separate public RC4 close-execute acceptance and stable decision.
