...
- Current source version is `0.4.1`.
- Current release target is stable `0.4.1`.
- Current published stable npm release target is `0.4.0` until the T-0516 approval-gated publish completes.
