...
- Current 0.5.0-rc.2 source status: T-0699 through T-0706 completed Init v1 implementation boundaries; T-0743 reduced the legacy status surface and decomposed close modules; T-0744 owns the final document-routing, legacy-isolation, installed-acceptance, and RC2 contract-freeze gate.
- Current 0.5.0-rc.2 source status: locally frozen after T-0744 current-head validation, package/consumer and clean-checkout evidence, strict release gate, release dry-run, installed lifecycle acceptance, and closed-valid proof. Publication status: not published; remote CI and operator-controlled npm/GitHub publication or registry mutation remain separate pending operations.
