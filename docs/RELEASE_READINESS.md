...
- Current 0.4.4 release-candidate publish status: T-0579 prepares source/readiness only. Exact npm version availability must be checked before publish; npm/GitHub publication and post-publish installed-package recycle remain separate operator-controlled steps.
