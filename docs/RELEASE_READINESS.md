...
- Current 0.5.0-rc.2 readiness status: source candidate only until T-0744 records current-head validation, package/consumer and clean-checkout evidence, strict release gate, release dry-run, and close proof. No npm/GitHub publication or registry mutation is included in this capsule.
