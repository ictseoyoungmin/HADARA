...
- Current 0.4.6-rc.0 source/preparation status: T-0604 closed residual brownfield trust gaps; T-0605 improved evidence category UX and manifest inference polish; T-0606/T-0607 recorded delegated Antigravity/Codex onboarding dogfood; T-0608 fixed delegated onboarding UX findings; T-0609 hardened validation execution capture; T-0610 retired stale bootstrap next-work after first close; T-0611 through T-0613 clarified current-state latest-task and trusted validation-baseline contracts.
- Current 0.4.6-rc.0 readiness: focused current-state/evidence/validation tests passed; TypeScript builds passed; Docker dev sync build/full suite passed through T-0613 with 153 files and 1108 tests and `distLooksStale=false`. Source preparation in T-0614 retargets package metadata, release notes, readiness docs, README release status, and the GitHub prerelease note artifact to `0.4.6-rc.0`. npm publish, GitHub Release publication, token loading, and installed-package recycle remain operator-controlled follow-up actions.
...
- Current source version is `0.4.6-rc.0`.
- Current release target is prerelease `0.4.6-rc.0`.
- Current release-candidate npm publish target is `0.4.6-rc.0` on dist-tag `next`.
- Current stable npm publish target remains `0.4.5` on dist-tag `latest`.
- Current published stable npm release target is `0.4.5`.
