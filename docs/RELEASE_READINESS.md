...
- Current stable npm publish status: `hadara@0.3.3` is published on npm through T-0406. Registry verification returned `0.3.3`, dist-tags verified `latest=0.3.3` and `next=0.3.3-rc.0`, and temporary-prefix installed-bin smoke passed. T-0340 previously published `hadara@0.3.2`; T-0316 previously published `hadara@0.3.0`.
