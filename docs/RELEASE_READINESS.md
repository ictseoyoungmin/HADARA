...
- Current version is `0.3.2-rc.0`.
- Current source version is `0.3.2-rc.0`.
- Current release target is release candidate `0.3.2-rc.0`.
...
- Stable `0.3.2` decision status: T-0339 selected stable publish after T-0336 readiness, T-0337 publish verification, T-0338 installed-package recycle, and T-0339 docker-compose dogfooding found no release-blocking issue; actual npm publish is approval-gated in T-0340.
