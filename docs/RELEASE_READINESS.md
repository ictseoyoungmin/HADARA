...
Current release-candidate metadata preparation mode:
...
- Current version is `0.4.0-rc.0`.
- Current source version is `0.4.0-rc.0`.
- Current release target is release candidate `0.4.0-rc.0`.
...
- Current release-candidate publish status: `hadara@0.4.0-rc.0` is published on npm with dist-tag `next` through T-0477. Registry verification returned `version=0.4.0-rc.0`, `latest=0.3.3`, and `next=0.4.0-rc.0`; GitHub Release draft creation was not requested.
- Current release-candidate source status: T-0477 prepared `hadara@0.4.0-rc.0` source/readiness after the T-0427 through T-0452 0.4 productization implementation line, T-0453 through T-0473 agent UX cleanup, and T-0474 through T-0476 final pre-release hardening. T-0478 fixed the publish environment helper safe-directory residual before the operator publish rerun.
