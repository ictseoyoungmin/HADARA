...
- Current version is `0.5.0-rc.0`.
- Current source version is `0.5.0-rc.0`.
- Current release target is prerelease `0.5.0-rc.0`.
- Current release-candidate npm publish target is `0.5.0-rc.0` on dist-tag `next`.
