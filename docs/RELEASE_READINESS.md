...
- Current release-candidate source status: T-0477 prepares `hadara@0.4.0-rc.0` source/readiness after the T-0427 through T-0452 0.4 productization implementation line, T-0453 through T-0473 agent UX cleanup, and T-0474 through T-0476 final pre-release hardening. This source/readiness capsule performs no npm publish, GitHub Release creation, Docker image build/push, PyPI publish, registry mutation, installer execution, MCP release/package execution, or token loading.
- Previous published npm release candidate before the current source target is `0.3.4-rc.0`.
