...
- Current source version is `0.4.6`.
- Current release target is stable `0.4.6`.
...
- Current published stable npm release target remains `0.4.5` until the operator publishes this capsule.
