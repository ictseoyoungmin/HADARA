...
Detailed capsule candidates live in `docs/archive/retired-2026-07-26/V1_0_CAPSULE_BACKLOG.md`. Detailed schemas and implementation notes live in `docs/archive/retired-2026-07-26/V1_0_IMPLEMENTATION_SCHEMAS.md`. Release/install/package-smoke sequencing is tracked in `docs/DEVELOPMENT_SLICES.md` and `docs/archive/retired-2026-07-26/V1_0_CAPSULE_BACKLOG.md`; a workspace-local ignored supporting plan may exist under `docs/specs/` for agents.
...
Future documentation-routing refactor: define a lifecycle for Required Reading spec registration so completed implementation specs can move out of active routing and into historical/reference discovery without being deleted. The follow-up is recorded in `docs/archive/retired-2026-07-26/REQUIRED_READING_LIFECYCLE_FOLLOWUP.md` and should be handled as a separate phase, not as a detour before the next `0.3.2` Evidence v2 task.
