...
- Active-run projection/resume schema fixtures exist for `hadara.active_run.projection.v1` and `hadara.active_run.resume.v1`; runtime schema validation remains deferred.
