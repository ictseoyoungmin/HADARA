...
describe('schema fixtures', () => {
  it('keeps the schema index aligned with parseable JSON Schema fixtures', () => {
    ...
    expect(index.schemas.map((entry) => entry.id).sort()).toEqual([
      ...
      'hadara.docs.inbox.v1',
      'hadara.docs.list.v1',
      'hadara.docs.mark.v1',
      'hadara.docs.patchPlan.v1',
      'hadara.docs.readMap.v1',
      'hadara.docs.register.v1',
      'hadara.docs.registryMutation.v1',
      'hadara.docs.requiredReading.v1',
      'hadara.docsRegistry.v3',
      'hadara.documents.v1',
      'hadara.event.v1',
      ...
      'hadara.releaseCurrentStateProjection.v1',
