...
import publicLifecycleAcceptanceSchemaJson from '../schemas/public-lifecycle-acceptance.schema.json';
...
const registeredSchemas: Record<string, JsonObject> = {
  ...
  'hadara.publicLifecycleAcceptance.v1': publicLifecycleAcceptanceSchemaJson as JsonObject,
