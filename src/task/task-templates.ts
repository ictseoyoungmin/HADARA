...
function taskMarkdown(task: TaskCapsule, goal: string, notes: string, scopeRows: string[], outOfScope: string[]): string {
  ...
  return `# ${task.id} ${task.title}\n\n## Identity\n\n| Field | Value |\n|---|---|\n| ID | ${task.id} |\n| Title | ${task.title.replace(/\|/g, '/')} |\n| Status | Draft |\n| Created | ${timestamp} |\n| Updated | ${timestamp} |\n\nLifecycle note: do not hand-edit Identity \`Status\` or \`docs/TASK_BOARD.md\` Status to close work. Keep the task prose current, then run \`hadara task close --task ${task.id} --json\`.\n\n## Goal\n\n| Goal | Notes |\n|---|---|\n| ${goal} | ${notes} |\n\n## Scope\n\n| Boundary | Items |\n|---|---|\n| In | ${scopeRows.map((row) => row.replace(/\s*\|\s*/g, ' ')).join('<br>')} |\n| Out | ${outOfScope.join('<br>') || 'TBD'} |\n\n## Plan\n\n| Step | Action | Status |\n|---|---|---|\n${scopeRows.map((row, index) => `| ${index + 1} | ${row.replace(/\s*\|\s*/g, ' ')} | Pending |`).join('\n')}\n| ${scopeRows.length + 1} | Validate and record evidence. | Pending |\n\n## Acceptance\n\n| ID | Criterion | State | Evidence | Reference |\n|---|---|---|---|---|\n| AC-1 | Template-specific scope is implemented. | Pending | TBD | TBD |\n| AC-2 | Template expected evidence is recorded. | Pending | TBD | TBD |\n\n## Validation\n\n| Check | Gate | Result | Evidence |\n|---|---|---|---|\n| TBD | Yes | Not Run | TBD |\n\n## Inputs / Constraints\n\n| Source | Role | State | Notes |\n|---|---|---|---|\n| TBD | reference | active | TBD |\n\n## Changes\n\n| Area | Summary |\n|---|---|\n| N/A | TBD |\n\n## Risks / Follow-ups\n\n| ID | Type | Summary | State | Link |\n|---|---|---|---|---|\n${outOfScope.map((item, index) => `| RF-${index + 1} | Follow-up | ${item} | Deferred | Template boundary. |`).join('\n')}\n\n## History\n\n| Date | State | Note |\n|---|---|---|\n| ${formatLocalDate()} | Draft | Initial task scaffold. |\n`;
}
