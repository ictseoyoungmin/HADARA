...
export const TASK_FILES: Record<string, (task: TaskCapsule) => string> = {
  'TASK.md': (task) => {
    ...
    const targetsRow = renderTaskTargets(task.targets) === 'project' ? '' : `| Targets | ${renderTaskTargets(task.targets)} |\n`;
