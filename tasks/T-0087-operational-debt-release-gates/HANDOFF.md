...
- Added read-only `hadara release gate --mode advisory|strict --json`; advisory warns on open high-severity operational debt, strict reports `ok: false`, and neither mode executes release actions.
