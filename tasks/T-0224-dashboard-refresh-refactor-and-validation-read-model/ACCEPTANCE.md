...
| AC-5 | Done-level validation rejects completed Task Capsules whose `TASK.md` Created/Updated metadata is still placeholder or invalid. | Met | Harness regression test rejects placeholder metadata; Docker sync-build passed 90 files / 589 tests after fixture updates. |
