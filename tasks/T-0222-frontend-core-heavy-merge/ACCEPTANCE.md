...
| AC-6 | Handoff is updated. | Done | Task handoff records T-0223 as next step; follow-up Docker build/validation evidence records the served-bundle rebuild and sync-build pass. |
