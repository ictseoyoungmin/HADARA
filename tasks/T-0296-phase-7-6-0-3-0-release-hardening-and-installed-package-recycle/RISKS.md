...
| Release dry-run cannot run while worktree is dirty. | Release evidence would be blocked. | High | Commit source/docs/evidence before `release artifact --execute`, then append release evidence in a follow-up commit. | Open until release artifact passes |
