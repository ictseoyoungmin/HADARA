...
|---|---|---|---|
| `package.json` | Updated | Set source candidate version to `0.3.0-rc.0`. | Done |
| `package-lock.json` | Updated | Keep lockfile package version aligned with source candidate. | Done |
| `README.md` | Reworked | Present Phase 7.6 release status, lifecycle, docs governance, managed patch safety, release boundaries, and install guidance. | Done |
