...
| `scripts/release/manual-publish-rc.sh` | Updated | Remove stale T-0143 default/examples, require explicit task id, add clean worktree guard, run release artifact before evidence-attach steps, carry approval metadata through dry-run gates, and attach post-publish evidence after npm view verification. | Done |
