...
| `docs/TASK_BOARD.md` | Update | Track T-0326 lifecycle status. | Done |
| `docs/PROJECT_STATE.md` | Update | Reflect active/done rc1 readiness state and next publish/recycle capsules. | Done |
| `docs/AGENT_HANDOFF.md` | Update | Hand off T-0327/T-0328 after T-0326 readiness. | Done |
| `docs/DEVELOPMENT_SLICES.md` | Update | Add T-0326 release-readiness slice and next release capsules. | Done |
| `tasks/T-0326-0-3-1-rc-1-release-readiness-preparation/` | Update | Capsule docs, evidence, and release artifacts. | Done |
