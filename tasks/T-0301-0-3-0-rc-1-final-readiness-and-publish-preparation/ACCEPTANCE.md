...
| AC-3 | README and release readiness docs reflect rc.1 publish state after operator execution. | Done | README and `docs/RELEASE_READINESS.md`. |
...
| AC-6 | Operator npm publish is recorded with release evidence, npm view verification, and GitHub draft status. | Done | T-0301 publish evidence from 2026-06-12; GitHub draft false. |
