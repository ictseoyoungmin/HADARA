...
|---|---|---|---|
| `package.json` | Update | Stable source version target. | Done |
| `package-lock.json` | Update | Keep lockfile root metadata aligned with package version. | Done |
| `README.md` | Update | Package-facing stable install/status text for `0.3.2`. | Done |
| `docs/RELEASE_NOTES.md` | Update | Add stable `0.3.2` release entry. | Done |
| `docs/RELEASE_READINESS.md` | Update | Track stable `0.3.2` source/readiness and approval-gated publish status. | Done |
