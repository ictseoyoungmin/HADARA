...
| 3 | Preserve publish mutation boundary until operator npm auth and explicit confirmation are available. | Done | `ev:T-0337:26b2d2a2606c40ab81ca31f3` |
| 4 | After operator publish, verify npm version, dist-tags, tarball/README/package metadata. | Done | `ev:T-0337:ba28cd4d16fb4952ab3aefd7` |
| 5 | Attach publish/verification evidence and hand off T-0338 recycle. | Done | T-0338 capsule created |
