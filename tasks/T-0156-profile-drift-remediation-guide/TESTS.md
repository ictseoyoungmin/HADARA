...
|---|---|---|---|---|
| Docker focused Vitest | Run protocol profile/unit and CLI regressions. | Yes | Passed: 2 files / 21 tests. | Added explicit profile summary edge cases, then ran `docker exec hadara-dev ... npx vitest run tests/unit/protocol-consistency.test.ts tests/unit/protocol-cli.test.ts`. |
