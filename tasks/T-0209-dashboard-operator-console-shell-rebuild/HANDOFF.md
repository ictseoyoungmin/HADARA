...
| Item | Evidence |
|---|---|
| Rebuilt the operator console shell with one verdict and ambient provenance. | app.tsx, ui.tsx, app.css. |
| Hardened the read path with a fetch timeout to avoid console freeze. | model.ts. |
