...
Release-gate readiness now includes `REMOTE_CI_OBSERVATION_UNRECORDED`, which checks local documentation for remote CI observation evidence. It remains read-only and does not call GitHub, trigger workflows, publish packages, deploy, or execute release actions.
