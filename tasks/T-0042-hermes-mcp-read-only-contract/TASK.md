...
- Clarify MCP tool result payload wrapping before server skeleton implementation.
- Align task JSON summaries with the MCP contract by including Task Capsule status.
