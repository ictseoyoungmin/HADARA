...
| AC-4 | Release artifact/package/clean-checkout/release gate/dry-run checks pass or any blocker is fixed before handoff. | Pending | `ev:T-0583:7124c5762ff64ec5b166cb69`, `ev:T-0583:f0ed9b5cb09f429198437689`, `ev:T-0583:308d82caa20f47a59cbc9415` | release validation evidence; release artifact reruns after hotfix commit |
| AC-5 | Stable publish remains explicitly operator-controlled after this source-preparation capsule. | Pending | `ev:T-0583:dfdcd307bd2b40e2bbf9df80` | `HANDOFF.md`, helper scripts |
...
| Release artifact / release dry-run / publish dry-run | Yes | Pending | Requires clean hotfix commit first. |
...
| RF-2 | Risk | `release artifact` requires a clean source-prep/hotfix commit; rerun it after this source state is committed. | Open | `ev:T-0583:b4c516001bd248fabf5fe8f3` |
