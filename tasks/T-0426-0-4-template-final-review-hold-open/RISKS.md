...
| Keeping capsule open could leave shared state temporarily pointing at an unfinished task. | Next worker may assume docs are final. | Medium | Mark T-0426 In Progress and note that T-04A1 registration waits for operator acceptance. | Open |
