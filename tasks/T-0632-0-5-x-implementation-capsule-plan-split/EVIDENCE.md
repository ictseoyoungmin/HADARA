...
| ev:T-0632:4605bb3d3a4e40d9a5337f24 | passed | validation | Validation "Release-plan structure and source-coverage audit" passed; command: bash -lc set -euo pipefail test "$(find docs/specs/0.5 -mindepth 2 -maxdepth 2 -path "*/0.5.*/*.md" -type f / wc -l)" -eq 6 test "$(rg "^\/ 05[0-5]-C[0-9][0-9] " docs/specs/0.5/0.5.*/*.md / wc -l)" -eq 32 test "$(rg -l "^## Capsule budget$" docs/specs/0.5/0.5.*/*.md / wc -l)" -eq 6 test "$(rg -l "^## Validation and acceptance$" docs/specs/0.5/0.5.*/*.md / wc -l)" -eq 6 test -f docs/specs/0.5/README.md test -f docs/specs/0.5/0.5.4/HADARA_0_5_4_Dogfood_and_Hardening_Development_Plan.md test -f docs/specs/0.5/0.5.5/HADARA_0_5_5_Stabilization_and_Promotion_Development_Plan.md rg "six release folders" docs/specs/0.5/README.md >/dev/null rg "0.5.5" docs/specs/0.5/README.md >/dev/null rg "v1 status contracts remain available" docs/specs/0.5/0.5.0/HADARA_0_5_0_Status_Ingress_and_Evaluation_Development_Plan.md >/dev/null; exitCode: 0; signal: null; durationMs: 626; stdoutHash: sha256:e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855; stderrHash: sha256:e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855 |
| ev:T-0632:53374886476a48e6ab7cc3c1 | passed | validation | Validation "Markdown links and docs governance checks" passed; command: bash -lc set -euo pipefail for p in \ docs/specs/0.5/README.md \ docs/specs/0.5/0.5.0/HADARA_0_5_0_Status_Ingress_and_Evaluation_Development_Plan.md \ docs/specs/0.5/0.5.1/HADARA_0_5_1_Task_Close_Transaction_Development_Plan.md \ docs/specs/0.5/0.5.2/HADARA_0_5_2_Public_Close_Migration_Development_Plan.md \ docs/specs/0.5/0.5.3/HADARA_0_5_3_Structured_State_and_Projection_Development_Plan.md \ docs/specs/0.5/0.5.4/HADARA_0_5_4_Dogfood_and_Hardening_Development_Plan.md \ docs/specs/0.5/0.5.5/HADARA_0_5_5_Stabilization_and_Promotion_Development_Plan.md; do test -f "$p" done node dist/cli/main.js docs doctor --scope all --json > /tmp/hadara-t0632-docs-doctor.json node -e "const fs=require('fs'); const j=JSON.parse(fs.readFileSync('/tmp/hadara-t0632-docs-doctor.json','utf8')); if(!j.ok // j.summary.health !== 'healthy' // j.summary.currentnessVerdict !== 'clean') { console.error(JSON.stringify(j.summary)); process.exit(1); }"; exitCode: 0; signal: null; durationMs: 925; stdoutHash: sha256:e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855; stderrHash: sha256:e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855 |
