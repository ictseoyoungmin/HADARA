...
|---|---|---|---|
| `package.json` | Modified | Bump source package version to `0.2.0-rc.3`. | Done |
| `package-lock.json` | Modified | Align lockfile root package version with rc3. | Done |
| `README.md` | Modified | Document rc3 as source publish candidate and rc2 as latest npm-published RC. | Done |
