...
| Release artifact evidence cannot be generated from a dirty worktree. | Release dry-run remains blocked. | High | Created checkpoint commit before release artifact refresh, then attached final evidence. | Mitigated |
