...
- Keep the first implemented profile as `core` only. It validates core service/read-model surfaces without installed-binary execution, package-smoke execution, or strict evidence gates.
