...
- [x] The report explicitly records service/read-model execution and false installed-binary/launcher/package-install checks.
- [x] Registered sub-report schemas are validated before a step is marked passed.
