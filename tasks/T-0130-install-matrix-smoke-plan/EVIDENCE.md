...
|---|---|---|---|
| 2026-05-28T10:19:37Z | test-log | Docker temp-copy focused release-gate regression passed: `tests/unit/operational-debt.test.ts`; 22 tests. | passed |
| 2026-05-28T10:19:37Z | test-log | Docker temp-copy `npm run check` passed after install matrix planning gate update: TypeScript build, 50 test files, 353 tests. | passed |
