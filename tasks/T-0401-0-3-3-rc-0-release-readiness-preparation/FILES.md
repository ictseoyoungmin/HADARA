...
|---|---|---|---|
| `package.json` | Update | Set source package version to `0.3.3-rc.0`. | Done |
| `package-lock.json` | Update | Keep lockfile package metadata aligned with source version. | Done |
| `README.md` | Update | Present stable `0.3.2` and current `0.3.3-rc.0` release-candidate guidance. | Done |
